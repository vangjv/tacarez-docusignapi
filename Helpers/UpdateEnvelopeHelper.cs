...
namespace TacarEZDocusignAPI.Helpers
{
    class UpdateEnvelopeHelper
    {
        public static string UpdateEnvelopeWith2Documents(EnvelopeRequest envelopeRequest, string accessToken, string basePath, string accountId, string envelopeId)
        {
            ...
            //docToUpDate.
            var results = envelopesApi.UpdateDocumentsWithHttpInfo(accountId, envelopeId, env);            
